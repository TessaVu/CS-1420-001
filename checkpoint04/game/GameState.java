...
//    	System.out.println("Clicked.");
     ...
     * @return None.
     */
    public void drawAll(Graphics g, GameView v)
    {
    	for(Animatable a : gameObjects)
    		a.draw(g, v);    	
    }
    ...
    /**
     * Finds and returns the enemy nearest to the
     * specified point.
     * 
     * @param p		A point object.
     * @return A reference to the enemy nearest the point, or null if none.
     */
    public Enemy findNearestEnemy(Point p)
    {
    	// Optimization loop.
    	// Set the closest value as null.
    	Enemy closest = null;
    	
    	// For every animatable object in gameObjects...
    	for(Animatable a : gameObjects)
    	{
    		// If the object is an enemy...
    		if(a instanceof Enemy)
    		{
    			// Make sure the enemy is an enemy.
    			Enemy e = (Enemy) a;
    			
    			// If the closest value is null...
    			if(closest == null)
    			{
    				// Set the closest value equal to the enemy.
    				closest = e;
    			}
    			else
    			{
    				// Retrieve the location of the nearest enemy.
    				...
    				// If the distance to the enemy is less than the distance to the current closest enemy...
