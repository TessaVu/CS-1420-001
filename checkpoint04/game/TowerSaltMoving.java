...
public class TowerSaltMoving implements Animatable
{
	...
	public void update(double timeElapsed)
	{
		...
		if(state.isMouseClicked() && p.distanceToNearestPathNode(q) > 2500 && state.getCredits() >= 600)
		{
	...
	{
		v.drawCenteredImage(g, "salt.png", state.getMouseX(), state.getMouseY(), 1.2);
	}
}
