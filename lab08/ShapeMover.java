/* ShapeMover is a program used to generate
 * circle and rectangle shapes in a frame
                                                  ...
                                                  Runnable
{
    ...
    public ShapeMover ()
    {
    	// Make shapes by storing a new Shape array in shapes.
    	shapes = new Shape[]
    	    {
    	    	// Set values as circles or rectangles in Shape array.
    	    	new Rect(130,  40,  60, 66, Color.RED),
    	    	new Circle(230,  40,  20, Color.BLUE),
    	    	new Rect(330,  40,  80, 19, Color.GREEN.darker()),
    	   		new Circle(130, 140, 100, new Color (0.8f, 0.6f, 0.2f)),
    	   		new Rect(30, 140,  40, 52, Color.YELLOW)
    	    };
